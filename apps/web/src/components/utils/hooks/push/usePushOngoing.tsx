                ...
                <div className='md:w-[100%] 2xl:max-w-screen-xl grow max-w-[100%] sm:w-[100%] w-[100%]  flex items-center justify-center'>
                    <Card className='w-[100%] sm:w-[90%] md:w-[95%] md:mt-4 sm:mt-4 mt-1'>
                        <div className='pt-4 pb-4'>
                            ...
                            <div className='relative'>
                                ...
                                <div className="absolute bottom-2 right-5 sm:right-10 md:right-10">
                                    <Video showOngoingCall={showOngoingCall} videoFramestyles="h-[120px] w-[198px] rounded-2xl bg-white object-cover sm:h-[143px] sm:w-[254px] md:h-[143px] md:w-[254px]" />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='mb-4 cursor-pointer mt-2 flex items-center justify-center gap-2.5'>
                            <MediaToggleButton iconSrc={"/push/videobtn.svg"} buttonStyles='bg-white p-3 border-[#D4D4D8] border w-[48px] h-[48px] rounded-[10px]' onClick={() => setShowOngoingCall(false)} />
                            <MediaToggleButton iconSrc={"/push/micbtn.svg"} buttonStyles='bg-white w-[48px] h-[48px] p-3 border-[#D4D4D8] border rounded-[10px]' onClick={() => setShowOngoingCall(false)} />
