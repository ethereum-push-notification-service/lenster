  ...
  return (
    <div className="absolute bottom-8 gap-2 mt-2 left-0 right-0 m-auto flex flex-row items-center justify-center sm:static md:static">
      <Image
        ...
        className="p-3 border-[#D4D4D8] border w-[48px] h-[48px] rounded-[10px]"
        alt="call"
      />
      <Image src="/push/micbtn.svg" className="w-[48px] h-[48px] p-3 border-[#D4D4D8] border rounded-[10px]" alt="call" />
      <Image
